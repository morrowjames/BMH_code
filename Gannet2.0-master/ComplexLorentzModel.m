function Lorentz=ComplexLorentzModel(x, freq)
% CJE LorentzModel
...
Lorentz = (Absorption+1i*Dispersion)*exp(1i*phase) ...
    + baseline0 + baseline1*(freq-f0);
%Absorption*cos(phase) - Dispersion * sin(phase) ...
    %+1i*(Dispersion*cos(phase)+Absorption*sin(phase))
	  %+ baseline0 + baseline1*(freq-f0);
